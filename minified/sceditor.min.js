    ...
    function generateTableOfContents() {
        ...
        if (headings.length > 0) {
            ...
            headings.forEach((heading) => {
                ...
                tocHtml += `<li style="font-size: 14px;font-weight: bold;margin-bottom: 5px;"><a href="#${headingId}" style="color: #a87fe5;text-decoration: none;">${headingText}</a></li>`;
            });
            tocHtml += '</ul></div>';
        }
            ...
            horizontalrule: {
                ...
                exec: function(button) {
                    ...
                    if (selectedText) {
                        ...
                        var existingHeadingMatch = selectedText.match(/^<h[1-6]>/i);
