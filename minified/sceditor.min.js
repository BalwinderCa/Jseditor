/* SCEditor v3.2.0 | (C) 2017, Sam Clarke | sceditor.com/license */ ! function() {
    ...
    var bt = {
            toolbar: "undo,redo|bold,italic,underline,strike,subscript,superscript|left,center,right,justify|font,size,color,removeformat|cut,copy,pastetext|bulletlist,orderedlist,indent,outdent|table|toc|code,quote|image,email,link,unlink|emoticon|ltr,rtl|maximize,source",
            toolbarExclude: null,
