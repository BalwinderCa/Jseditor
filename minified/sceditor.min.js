/* SCEditor v3.2.0 | (C) 2017, Sam Clarke | sceditor.com/license */ ! function() {
    ...
    var Pe = {
            ...
            toc: {
                exec: function() {
                    var tocHtml = generateTableOfContents(); // Generate the table of contents HTML
                    this.wysiwygEditorInsertHtml(tocHtml); // Insert the table of contents HTML into the editor
            
                    // Attempt to access the iframe's document directly after a brief delay to ensure the content is loaded
                    setTimeout(() => {
                        const iframe = document.querySelector('iframe'); // Adjust selector as necessary
                        const iframeDoc = iframe.contentDocument || iframe.contentWindow.document;
            
                        // Find the div with id 'this_area_is_uneditable' and set contenteditable="false"
                        const tocDiv = iframeDoc.getElementById('this_area_is_uneditable');
                        if (tocDiv) {
