/* SCEditor v3.2.0 | (C) 2017, Sam Clarke | sceditor.com/license */ ! function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelector('iframe').contentWindow.document.body.addEventListener('click', function(event) {
            ...
            event.target.closest('*').setAttribute('data-unique-id', uniqueId);
        ...
        function replaceTagInIframe(tagName, uniqueId) {
            ...
            var elements = iframeDocument.querySelectorAll('div[data-unique-id="' + uniqueId + '"], p[data-unique-id="' + uniqueId + '"], h1[data-unique-id="' + uniqueId + '"], h2[data-unique-id="' + uniqueId + '"], h3[data-unique-id="' + uniqueId + '"], h4[data-unique-id="' + uniqueId + '"], h5[data-unique-id="' + uniqueId + '"], h6[data-unique-id="' + uniqueId + '"]');
            elements.forEach(function(element) {
                var newElement = document.createElement(tagName);
                newElement.innerHTML = element.innerHTML;
                newElement.setAttribute('data-unique-id', uniqueId); // Add the data-unique-id attribute
                    ...
                    fileInput.addEventListener('change', function() {
                        ...
                        if (file) {
                            ...
                            reader.onload = function (event) {
                                var img = new Image();
                                img.onload = function() {
                                    var width = prompt('Enter the width (leave blank for original):', img.width);
                                    var height = prompt('Enter the height (leave blank for original):', img.height);
                                    ...
                                    imgHtml += ' />';
                                    self.wysiwygEditorInsertHtml(imgHtml);
                                };
